...
1. **Credenciales demo en el login** — el diseño muestra `admin / 1234`, pero el seed real es `admin / admin123` y `vendedor / vende123`. *Solo texto de ayuda del prototipo; sin impacto funcional.*
...
4. **Configuración enriquecida** — el diseño añade **presets de color** y **slider de radio de bordes**. El informe/código solo tenían color picker. → *Pendiente (enhancement opcional).*
5. **Comparativo de Reportes** — el diseño muestra columnas Hoy / #ventas / Mes / Ganancia mes; el informe menciona además columnas de "rango" cuando hay filtro activo. *El diseño es una versión simplificada; no es un conflicto.*
