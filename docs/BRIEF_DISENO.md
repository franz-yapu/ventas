...
- **Escritorio**: barra lateral fija de **230px**, con tres grupos — operativo
  (Vender · Ventas · Productos · Inventario · Caja), _Análisis_ (Panel · Reportes ·
  Lectura Z) y _Administración_ (Ubicaciones · Usuarios · Actividad · Config · Mi plan).
...
- **Móvil**: barra inferior fija con 5 destinos como máximo, respetando
  ...
  sincronización.
- Los grupos _Análisis_ y _Administración_ sólo los ve un administrador, y algunas
