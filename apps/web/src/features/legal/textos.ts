 ...
 *
 * Los títulos van SIN número. La numeración la pone `LegalPage` a partir del orden, que
 * es donde tiene que estar: cuando venían escritos aquí, la página añadía el suyo encima
 * y cada sección salía como "1. 1. Quiénes somos". Y además, insertar una sección en
 * medio obligaba a renumerar todas las de abajo a mano.
 *
...
export const TERMINOS: Seccion[] = [
  {
    titulo: 'Quiénes somos y qué es este servicio',
    parrafos: [
  ...
  {
    titulo: 'Si te atrasas en el pago',
    parrafos: [
  ...
  {
    titulo: 'Facturación e impuestos',
    parrafos: [
...
export const PRIVACIDAD: Seccion[] = [
  ...
  {
    titulo: 'Sesión y almacenamiento en tu dispositivo',
    parrafos: [
