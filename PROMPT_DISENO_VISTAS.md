...
**Campos:** usuario, contraseña. Botón "Ingresar" (con estado _cargando_ que lo deshabilita).
...
- **Derecha — carrito:** lista de líneas (nombre, precio, cantidad con **+/−**, botón eliminar), y al pie:
  ...
  - _(Solo online)_ selector de **comprador** + botón "nuevo cliente"; campo **descuento** en Bs.
...
_Basado en `INFORME_PROYECTO.md`. Referencia de campos, roles y endpoints: ver ese documento._
</content>
